			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Danh sách học phí sinh viên </b>
						...
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="">Học phí phải trả</th>
									<th class="">Trả</th>
									<th class="">Số tiền còn lại</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-outline-primary edit_fees" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-outline-danger delete_fees" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.view_payment').click(function(){
		uni_modal("Chi tiết thanh toán","view_payment.php?ef_id="+$(this).attr('data-id')+"&pid=0","mid-large")
		
	})
	$('#new_fees').click(function(){
		uni_modal("Ghi danh sinh viên","manage_fee.php","mid-large")
		
	})
	$('.edit_fees').click(function(){
		uni_modal("Quản lý chi tiết đăng ký của học sinh","manage_fee.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.delete_fees').click(function(){
		_conf("Bạn có chắc chắn xóa khoản phí này không?","delete_fees",[$(this).attr('data-id')])
	})
